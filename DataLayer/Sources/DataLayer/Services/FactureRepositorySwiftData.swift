...
public struct FactureRepositorySwiftData: FactureRepository {
    ...
    public func genererNumeroFacture(client: ClientModel) throws -> String {
    ...
    public func createFacture(client: ClientModel, numero: String) throws -> FactureModel {
        let facture = FactureModel(numero: numero, client: client)
